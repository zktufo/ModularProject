package com.greentown.buildgradle

import com.greentown.buildgradle.exten.ComExtension
import com.greentown.buildgradle.exten.LeoTransform
            ...
            if (!module.equals(mainmodulename)) {
                project.android.sourceSets {
                    main {
                        ...
                        j   ava.srcDirs = ['src/main/java', 'src/main/runalone/java']
...
//                project.android.registerTransform(new LeoTransform(project))
    ...
    private AssembleTask getTaskInfo(List<String> taskNames) {
        ...
        for (String task : taskNames) {
            if (task.toUpperCase().contains("ASSEMBLE")
                ...
                System.out.println(assembleTask.modules.toString())
                break
            }
        }
        return assembleTask
